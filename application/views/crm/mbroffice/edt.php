        ...
        <div class='row'>
                ...
                <div class='box bordered-box muted-border' style='margin-bottom:0;'>
                    ...
                    <div class='box-content' style="border-bottom: 0;">
                        ...
                        <form class="form form-horizontal" id="formReg" name="formReg" method="post"  enctype="multipart/form-data">
                            <input type="hidden" name="ob_office_idx" id="ob_office_idx" value='<?=$office_base['data']['ob_office_idx']?>'>
                            <input type="hidden" id="ob_img_width" name="ob_img_width" class="w100p" value="<?=$office_base['data']['ob_img_width']?>">
                            <input type="hidden" id="ob_img_height" name="ob_img_height" class="w100p" value="<?=$office_base['data']['ob_img_height']?>">
                            ...
                            <div class="table_area"><!-- table_area start -->
                                ...
                                <table class="write">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" id="ob_officeNm" name="ob_officeNm" class="w100p" value="<?=$office_base['data']['ob_officeNm']?>"/></td>
                                        <th scope="row">설립년도</th>
                                        <td><input type="text" id="datepicker1" name="ob_bltDt" class="w100p" value="<?=$office_base['data']['ob_bltDt']?>"/></td>
                                    </tr>
                                    <tr>
                                        <th scope="row">보유인력</th>
                                        <td><input type="text" id="ob_wrkrNum" name="ob_wrkrNum" class="w100p" value="<?=$office_base['data']['ob_wrkrNum']?>"/></td>
                                        <th scope="row">이메일</th>
                                        <td><input type="text" id="ob_email" name="ob_email" class="w100p" value="<?=$office_base['data']['ob_email']?>"/></td>
                                    </tr>
                                    <tr>
                                        <th scope="row">대표</th>
                                        <td><input type="text" id="ob_ceoNm" name="ob_ceoNm" class="w100p" value="<?=$office_base['data']['ob_ceoNm']?>"/></td>
                                        <th scope="row">연락처</th>
                                        <td><input type="text" id="ob_tel" name="ob_tel" class="w100p" value="<?=$office_base['data']['ob_tel']?>"/></td>
                                    </tr>
                                    <tr>
                                        <th scope="row"><label for="mb_photo">아이디</label></th>
                                        <td colspan="1">
                                            <input type="text" style="width:60%;" id="ac_id" name="ac_id" value="<?=$office_base['data']['ac_id']?>" />
                                            <a href="javascript: fn_id_dup_chk();" id="idDupVal">[ID 중복체크]</a>  <!--[ID 중복체크]-->
                                        </td>
                                        <th scope="row"><label for="mb_photo">아이디명</label></th>
                                        <td colspan="1">
                                            <input type="text" style="width:100%;" id="ac_nm" name="ac_nm" value="<?=$office_base['data']['ac_nm']?>" />
                                        </td>
                                        <th scope="row"><label for="mb_photo">비밀번호</label></th>
                                        <td colspan="1">
                                            <input type="text" style="width:60%;" id="ac_pwd" name="ac_pwd" value="<?//=$office_base['data']['ac_pwd']?>" />
                                    ...
                                    <tr style="display: none">
                                        ...
                                        <td colspan="5"><input type="text" id="ob_logo_bak" name="ob_logo_bak" class="w50p" value="<?=$office_base['data']['ob_filePath']?><?=$office_base['data']['ob_logo']?>"/></td>
                                    </tr>
                                    <tr style="display: ">
                                        <th scope="row"><label for="mb_photo">사업자번호</label></th>
                                        <td colspan="5"><input type="text" id="ob_bizNum" name="ob_bizNum" class="w50p" value="<?=$office_base['data']['ob_bizNum']?>"/></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="5">
                                            <input type="text"  id='ob_zip' name="ob_zip" maxlength=4   value="<?=$office_base['data']['ob_zip']?>" style="width:100px;" />
                                            <span class="in_btn"><a href="#" onclick="execDaumPostcode()" class="link_type" id="srchZip">우편번호검색</a></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="5">
                                            <input type="text" id="roadAddress" name="mb_addr0" value="$office_base['data']['ob_addr']" style="display:none;"/>
                                            <input type="text" style="width:35%;" id="jibunAddress" name="ob_addr"  value="<?=$office_base['data']['ob_addr']?>"  readonly="readonly;"/>
                                            <input type="text" style="width:35%;" id="mb_addr2" name="ob_addr_desc"  value="<?=$office_base['data']['ob_addr_desc']?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row"  class="v-top"><label for="mb-adrs">지도좌표</label></th>
                                        <td>
                                            <input type="text"  id='ob_latitud' name="ob_latitud"   value="<?=$office_base['data']['ob_latitud']?>" style="width:45%;" readonly/>
                                            &nbsp;&nbsp;
                                            <input type="text"  id='ob_longtitud' name="ob_longtitud"   value="<?=$office_base['data']['ob_longtitud']?>" style="width:45%;" readonly/>
                                        </td>
                                        <td colspan="4">
                                        ...
                                        <td colspan="5">
                                            <select id="sdg_sido_no" name='sdg_sido_no' class="w40p svcgds_inf" title="" style="float:left; width:30%;">
                                                ...
                                                foreach($sdg_sido_list['data'] as $k => $v) {
                                                    ?>
                                                    <option value='<?=$v['sdg_sido_no']?>'  <?=(trim($office_base['data']['ob_sido'])==trim($v['sdg_sido_no'])) ?' selected':''?> ><?=$v['sdg_sido_nm']?></option>
                                                    <?
                                                }
                                                ?>
                                            </select>
                                            <select id="sdg_gu_no" name='sdg_gu_no' class="w40p svcgds_inf" title="" style="float:left; width:30%;">
                                                <option value=''>선택하세요</option>
                                                <?
                                                foreach($office_gu_list['data'] as $k => $v) {
                                                    ?>
                                                    <option value='<?=$v['sdg_gu_no']?>'  <?=(trim($office_base['data']['ob_gu'])==trim($v['sdg_gu_no'])) ?' selected':''?> ><?=$v['sdg_gu_nm']?></option>
                                                    <?
                                                }
                                                ?>
                                            </select>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="5"><textarea cols="20" rows="10" class="memo_box" id="ob_memo"  name="ob_memo" ><?=$office_base['data']['ob_memo']?></textarea></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="1">
                                            <select id="ob_state" name='ob_state' class="w50p" title="상태선택">
                                                ...
                                                <option value='R'  <?=(trim($office_base['data']['ob_state'])=='R') ?' selected':''?> >대기</option>
                                                <option value='N'  <?=(trim($office_base['data']['ob_state'])=='N') ?' selected':''?> >미승인</option>
                                                <option value='Y'  <?=(trim($office_base['data']['ob_state'])=='Y') ?' selected':''?> >승인</option>
                                            </select>
                                        </td>
                                        <td colspan="4">
                            ...
                            <div class="row2">
                                ...
                                <div class="col-md-1">
                                    <div class="btn_cls" >
                                        ...
                                        <div class="btn btn-primary btn_search btn-xs" >
                                            <a href="javascript:set_office_edt();" style="color:white;">저 장</a>
                                        </div>
                                ...
                                <div class="row2">
                                    ...
                                    <div class="col-md-1">
                                        <div class="btn_cls" >
                                            ...
                                            <div class="btn btn-primary btn_search btn-xs" >
                                                <a href="javascript:set_office_svcinf_reg();" style="color:white;">저 장</a>
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td scope="col">
                                        ...
                                        <div class="row2">
                                            ...
                                            <div class="col-md-1">
                                                <div class="btn_cls" >
                                                    <button class="btn btn-primary btn_search btn-xs" onclick="javascript: fn_reg_office_profile_proc('INS','<?=$row['ob_office_idx']?>','');">
                                                        저 장
                                                    </button>
                                                </div>
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td scope="col">
                                        ...
                                        <div class="row2">
                                            ...
                                            <div class="col-md-1">
                                                <div class="btn_cls" >
                                                    <button class="btn btn-primary btn_search btn-xs" onclick="javascript: fn_reg_taxAccnt_proc();">
                                                        저 장
                                                    </button>
                                                </div>
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td scope="col">
                                        ...
                                        <div class="row2">
                                            ...
                                            <div class="col-md-1">
                                                <div class="btn_cls" >
                                                    <button class="btn btn-primary btn_search btn-xs" onclick="javascript: fn_reg_client_proc();">
                                                        저 장
                                                    </button>
                                                </div>
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td scope="col">
                                        ...
                                        <div class="row2">
                                            ...
                                            <div class="col-md-1">
                                                <div class="btn_cls" >
                                                    <button class="btn btn-primary btn_search btn-xs" onclick="javascript: fn_reg_wrkfield_proc();">
                                                        저 장
                                                    </button>
                                                </div>
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td scope="col">
                                        ...
                                        <div class="row2">
                                            ...
                                            <div class="col-md-1">
                                                <div class="btn_cls" >
                                                    <button class="btn btn-primary btn_search btn-xs" onclick="javascript: fn_reg_intrvw_proc();">
                                                        저 장
                                                    </button>
                                                </div>
                                            </div>
            ...
            <script language="javascript">
                ...
                $(document).ready(function() {
                    ...
                    var ac_id_v= $('#ac_id').val();
                    if(ac_id_v != ''){
                        $('#idDupVal').text('');
                        $('#ac_id').prop({"readonly":"true"});
                    }

                    $("#ob_logo").each(function() {
                ...
                function set_office_edt(){
                    var url = '/crm/mbroffice/office_edt';
                    var formId = 'formReg';
                    var pwd = $('#ac_pwd').val();
                    ...
                    if(ac_id_v != '' && $('#idDupVal').text() == 'ID 중복체크 완료'){
                ...
                function get_office_svcinf()
                {
                    ...
                    var url = '/crm/mbroffice/getMbrsvc';
                    var data = {
                        "ob_office_idx" : ob_office_idx
                    }
                    console.log(data);
                    ...
                    ajax_post(url, data, function(ret) {
                        if(ret.msg == 'TRUE')
                        {
                            $('#ms_mbr_idx').val(ret.data.ms_mbr_idx);
                            $("#si_svcgds_idx").val(ret.data.si_svcgds_idx); //selectbox
                            $('#datepicker2').val(ret.data.ms_joinDt);
                            $("#ms_mbrgbn").val(ret.data.ms_mbrgbn); //selectbox
                            $('#ms_ttlAmt').val(ret.data.ms_ttlAmt);
                            $('#ms_ttlperiod').val(ret.data.ms_ttlperiod);
                            $('#datepicker3').val(ret.data.ms_freeBeginDt);
                            $('#datepicker4').val(ret.data.ms_freeEndDt);
                            $('#datepicker5').val(ret.data.ms_mbrBeginDt);
                            $('#datepicker6').val(ret.data.ms_mbrEndDt);
