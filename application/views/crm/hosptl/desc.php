    ...
    <div class="col-xs-12">
        ...
        <div class='row'>
                                ...
                                <div class="col-md-1">
                                    <div class="btn_cls" >
                                        ...
                                        <button class="btn btn-warning btn_search btn-xs" >
                                            <a href="javascript:set_hosptl_edt();" style="color:white;">저 장</a>
                                        </button>
            ...
            <script language="javascript">
                ...
                function set_hosptl_edt(){
                    var url = '/crm/hosptl/set_hosptl_edt';
                    var formId = 'formReg';
                    ...
                    $("#"+formId).ajaxForm({
                        ...
                        success : function(result){
                            ...
                            if(result.msg == 'TRUE') {
                                ...
                                //location.href = '/crm/hosptl/edt/'+$('#hb_idx').val();
                                location.href = '/crm/hosptl/desc/'+$('#hb_idx').val();
                            }
                        }
                    });
                    $("#"+formId).submit();
