...
nhn.husky.SE2M_AttachQuickPhoto = jindo.$Class({		
	...
	$ON_ATTACHPHOTO_OPEN_WINDOW : function(){			
		...
		this.htPopupOption.sProperties = "left=0,top=0,width=640,height=408,scrollbars=yes,location=no,status=0,resizable=no";
	...
	makePopupURL : function(){
		var sPopupUrl ="./sample/photo_uploader/photo_uploader.html";// "../plugin/editor/smarteditor/photo_uploader/popup/index.html";//"./sample/photo_uploader/photo_uploader.html";
