...
SpSlidemenu.prototype.setElement = function(main, slidemenu, button) {
    ...
    _this.slidemenuBody = _this.slidemenu.querySelector('.category');
    _this.slidemenuContent = _this.slidemenu.querySelector('.sub-menu');
    _this.slidemenuHeader = _this.slidemenu.querySelector('.status');
};
